    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <div className="mb-8 p-4 bg-blue-50 rounded">
          ...
          <p className="text-gray-600 mt-2"><strong>Position:</strong> {interview.jobTitle}</p>
          <p className="text-gray-600"><strong>Resume:</strong> Uploaded successfully</p>
        </div>
        ...
        <div className="mb-6">
          <label className="block text-gray-700 font-semibold mb-3">Interview Duration (minutes)</label>
          <select
            value={duration}
